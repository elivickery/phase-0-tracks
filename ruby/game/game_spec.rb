...
describe Game do
  ...
  it "adds the letter to the guessed array" do
    game.add_letter_to_guessed_array('p')
    expect(game.guessed_array).to eq ['p']
  end
  ...
  it "checks if letter has been guessed" do
    game.add_letter_to_guessed_array('p')
    expect(game.letter_has_been_guessed('p')).to eq true
  end
